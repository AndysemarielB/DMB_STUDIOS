        ...
        <section className="py-20 px-4 md:px-8 bg-gradient-to-b from-gray-900 to-black">
          <div className="max-w-5xl mx-auto">
            <motion.div
              ...
              className="mb-16 text-center"
            >
              <h2 className="text-4xl md:text-5xl font-serif mb-6">Influences & Inspirations</h2>
              <div className="w-24 h-1 bg-gold mx-auto mb-12"></div>
            </motion.div>
            ...
            >
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-12">
                ...
                <div className="aspect-square relative overflow-hidden">
                  <Image
                    src="https://images.unsplash.com/photo-1583846783214-7229a91b20ed?q=80&w=735&auto=format&fit=crop"
                    alt="Influence artistique"
                    fill
                    className="object-cover"
                  />
              ...
              <div className="prose prose-lg prose-invert max-w-none">
                <p className="text-lg leading-relaxed text-white/80">
                  Mon travail est influencé par un large éventail de sources, allant de l&apos;architecture
                  contemporaine à l&apos;art abstrait, en passant par les mouvements culturels et les voyages. Je suis
                  particulièrement inspiré par la façon dont différentes cultures abordent l&apos;esthétique et
                  l&apos;expression artistique.
                </p>

                <p className="text-lg leading-relaxed text-white/80 mt-6">
                  Parmi mes influences majeures, on retrouve des créateurs visionnaires comme Alexander McQueen, dont
                  l&apos;approche théâtrale et narrative de la mode a redéfini les limites de cette discipline.
                  J&apos;admire également le travail d&apos;artistes contemporains comme Olafur Eliasson, dont les
                  installations immersives transforment notre perception de l&apos;espace et de la lumière.
                </p>

                <p className="text-lg leading-relaxed text-white/80 mt-6">
                  La nature reste une source d&apos;inspiration inépuisable pour moi. Ses formes organiques, ses
                  textures et ses palettes de couleurs informent souvent mon travail, que ce soit directement ou
                  indirectement. Je suis fasciné par la façon dont les éléments naturels peuvent être réinterprétés dans
